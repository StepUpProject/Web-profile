  ...
  const consultations = [
    {
      ...
      question:"Apa peran utama teknologi blockchain dalam industri IT saat ini ?",
    ...
    },
    {
      ...
      question:"Apa langkah-langkah utama dalam merancang sebuah website yang responsif dan user-friendly?",
    ...
    },
    {
      ...
      question:"Bagaimana Anda mengukur keberhasilan sebuah website, dan alat apa yang biasa digunakan untuk menganalisis kinerja dan penggunaan pengguna?",
    ...
    <div>
      ...
      <main className="mt-16 font-body">
        <section className="relative text-center pt-10">
          ...
          />
          <h1 className=" inline-block text-2xl font-bold text-center">KONSULTASI</h1>
        </section>
